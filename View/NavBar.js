...
<div class="row" style = "border-bottom-style:solid; border-width: 5px; border-color: #000000; background-color: #a349a4;">
    <div class="col-12 col-xs-12 col-md-12 col-lg-12">
        ...
        <div class="dropdownNav">
            <button class="dropbtnNav" style= "text-decoration: underline;">Car Payments</button>
        </div>
        <div class="dropdownNav">
            <button class="dropbtnNav" style= "text-decoration: underline;">Amortization</button>
        </div>
        <a href="AccountPage.html" style="text-align: right;">
